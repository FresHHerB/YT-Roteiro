...
const ScriptGenerationPage: React.FC<ScriptGenerationPageProps> = ({ user, onBack, onNavigate }) => {
  ...
  const generateScript = async () => {
    if (!selectedChannelId || !scriptIdea.trim() || !selectedModel.trim()) {
      setMessage({ type: 'error', text: 'Selecione um canal, digite uma ideia para o roteiro e selecione um modelo.' });
      return;
    }
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className={`
                    ...
                    ${!selectedChannelId || !scriptIdea.trim() || !selectedModel.trim() || isGeneratingScript
